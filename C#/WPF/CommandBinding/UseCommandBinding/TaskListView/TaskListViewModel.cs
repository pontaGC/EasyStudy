...
namespace CommandBindingStudy
{
    internal sealed class TaskListViewModel : BindableBase
    {
        ...
        {
            //this.CommandBindings.Add(new CommandBinding(ApplicationCommands.Copy, this.Copy, this.CanCopy))
        }
        ...
        /// <summary>
        /// Gets a collection of the <see cref="CommandBinding"/>.
        /// </summary>
        public ObservableCollection<CommandBinding> CommandBindings { get; } = new ObservableCollection<CommandBinding>();
